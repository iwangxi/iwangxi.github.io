import{_ as e,p as n,q as s,Y as a}from"./framework-aa5c4115.js";const i={},c=a(`<p>欢迎来到程序猿的VLOG，一个基于 VuePress 和 vuepress-theme-reco 构建的博客。</p><h2 id="快速开始" tabindex="-1"><a class="header-anchor" href="#快速开始" aria-hidden="true">#</a> 快速开始</h2><p><strong>npx</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 初始化，并选择 2.x</span>
...
theme-cli init
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),l=[c];function r(t,d){return n(),s("div",null,l)}const p=e(i,[["render",r],["__file","index.html.vue"]]);export{p as default};
